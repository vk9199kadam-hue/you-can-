...
# Paths
LOCAL_DB = "d:/you can/local_db.json"
CONTENT_DIR = "d:/you can/external_sources/content/"
...
def ingest_all():
    ...
    # 1. Look for JSON files in external_sources/content/
    ...
    print(f"Ingestion Complete! Added {new_count} new questions to your laptop database.")
